...
public class PreenchimentoComSucessoPage {
	private DSL dsl;
	...
	public By testaScroll = By.id("frameButton");
	
	
	
	
	
	public  PreenchimentoComSucessoPage(WebDriver driver) {
	 dsl = new DSL(driver);
	}
	...
	String validaNome =	dsl.obterValorCampo(primeiroNome, "value");
		Assert.assertEquals(nome, validaNome );
		
	}
	
	public void setSobreNome( String sobrenome) {
		dsl.escreve(segundoNome, sobrenome);
		String validaSobrenome =	dsl.obterValorCampo(segundoNome, "value");
		Assert.assertEquals(sobrenome, validaSobrenome );
